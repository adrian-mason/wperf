...
3. **`tests/fixtures/cascade_oracle.py` as minimal oracle.** The 80-line Python 3 script implementing ADR-007 pseudocode can serve as a differential testing oracle for Phase 0 (#20), replacing the non-existent bottleneck.py cascade. (Restored from tag `archived/gate0-prototypes`.)
